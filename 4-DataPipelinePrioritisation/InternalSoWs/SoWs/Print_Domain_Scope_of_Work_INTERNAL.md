...
| 3-4 | Data profiling, event type & grain analysis, DBT model analysis |
| 5 | New model design, design review with stakeholders, revenue allocation rules, obtain sign-off |
...
| Week | Activities |
|------|------------|
| 6-7 | Build Conformed layer DBT models (phase-based for Funnel, grain-specific for Ordered) |
| 8-9 | Build Metrics layer DBT models, bridge tables |
| 9-10 | Semantic layer development (2 semantic views), Orchestration setup (2-hour event-based + daily scheduled) |
...
### Phase 3: Migration & Testing (Weeks 11-13)

**Objectives:** Migrate historical data, test thoroughly, deploy to DEV

| Week | Activities |
|------|------------|
| 11 | Migration strategy design, migration script development |
| 12 | Data reconciliation, integration testing |
| 13 | Data quality testing, DEV deployment |
...
### Phase 4: Documentation & Handover (Weeks 14-15)
...
| 15 | Knowledge transfer, final handover |
...
```mermaid
gantt
    title Print Domain - Project Timeline (15 Weeks)
    ...
    Current State Analysis (9.0d)         :p1b, 2026-03-02, 15d
    Transformation Analysis (9.0d)        :p1c, 2026-03-09, 12d
    New DBT Model Design (13.3d)          :p1d, 2026-03-16, 12d
    Design Approved                       :milestone, m1, 2026-04-04, 0d
    
    section Phase 2: Build
    DBT Model Build (13.5d)               :p2a, 2026-04-06, 12d
    Semantic Layer (8.5d)                 :p2b, 2026-04-13, 10d
    Orchestration Setup (5.5d)            :p2c, 2026-04-20, 8d
    Orchestration Live                    :milestone, m2, 2026-05-01, 0d
    
    section Phase 3: Migration & Testing
    Historical Data Migration (5.5d)      :crit, p3a, 2026-05-04, 10d
    Testing (5.0d)                        :p3b, 2026-05-11, 10d
    Deployment (2.0d)                     :p3c, 2026-05-18, 5d
    Migration Complete                    :milestone, m3, 2026-05-22, 0d
    
    section Phase 4: Documentation
    Documentation (4.5d)                  :p4a, 2026-05-25, 10d
    Final Handover                        :milestone, m4, 2026-06-05, 0d
    
    section Resources
    Lead Solution Architect (Wk 1-15)     :done, res1, 2026-03-02, 75d
    Senior Solution Architect (Wk 6-13)   :done, res2, 2026-04-06, 40d
```
...
```mermaid
pie showData
    title Effort Distribution by Phase (75.8 days)
    "Phase 1: Discovery & Design" : 31.3
    "Phase 2: Build" : 27.5
    "Phase 3: Migration & Testing" : 12.5
    "Phase 4: Documentation & Handover" : 4.5
```
...
```
═══════════════════════════════════════════════════════════════════════════════════════════════════════════
                                    PRINT DOMAIN - PROJECT TIMELINE (15 WEEKS)
═══════════════════════════════════════════════════════════════════════════════════════════════════════════
...
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║ PHASE 1: DISCOVERY & DESIGN (31.3 days)                                                                   ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Week 1-5                                                                                                  ║
║ ┌─────────────────────────────────────────────┐                                                           ║
...
║ └─────────────────────────────────────────────┘                                                           ║
║ ┌─────────────────────────────────────────────────────────────────┐                                       ║
║ │ Current State Analysis (9.0d)                                   │ Wk 1-3                                ║
║ │ ████████████████████████████████████████████████████            │                                       ║
║ └─────────────────────────────────────────────────────────────────┘                                       ║
║ ┌─────────────────────────────────────────────────────┐                                                   ║
║ │ Transformation Layer Analysis (9.0d)                │ Wk 2-3                                            ║
║ │ ████████████████████████████████████████            │                                                   ║
║ └─────────────────────────────────────────────────────┘                                                   ║
║ ┌─────────────────────────────────────────────────────────────────┐                                       ║
║ │ New DBT Model Design (13.3d)                                    │ Wk 3-5                                ║
║ │ ██████████████████████████████████████████████████████          │                                       ║
║ └─────────────────────────────────────────────────────────────────┘                                       ║
║                                                                                                           ║
║ MILESTONES:                                                                                               ║
║   ◆ Wk 1: Infrastructure ready, HLDD received                                                             ║
║   ◆ Wk 3: Current state analysis complete                                                                 ║
║   ◆ Wk 5: Solution Design Document approved, Design sign-off                                              ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════╝

╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║ PHASE 2: BUILD (27.5 days)                                                                                ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Week 6-10                                                                                                 ║
║                         ┌─────────────────────────────────────────┐                                       ║
║                         │ New DBT Model Build (13.5d)             │ Wk 6-8                                ║
║                         │ ██████████████████████████████████████  │                                       ║
║                         └─────────────────────────────────────────┘                                       ║
║                         ┌─────────────────────────────────────────┐                                       ║
║                         │ Semantic Layer Development (8.5d)       │ Wk 8-9                                ║
║                         │ ██████████████████████████████████      │                                       ║
║                         └─────────────────────────────────────────┘                                       ║
║                         ┌─────────────────────────────────────────┐                                       ║
║                         │ Orchestration Setup (5.5d)              │ Wk 9-10                               ║
║                         │ ██████████████████████████████████      │                                       ║
║                         └─────────────────────────────────────────┘                                       ║
║                                                                                                           ║
║ MILESTONES:                                                                                               ║
║   ◆ Wk 8:  Conformed & Metrics layer DBT models complete                                                  ║
║   ◆ Wk 9:  Semantic views deployed, Airflow infrastructure ready                                          ║
║   ◆ Wk 10: Orchestration operational                                                                      ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════╝

╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║ PHASE 3: MIGRATION & TESTING (12.5 days)                                                                  ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Week 11-13                                                                                                ║
║                                                 ┌─────────────────────────────────────┐                   ║
║                                                 │ Historical Data Migration (5.5d)    │ Wk 11             ║
║                                                 │ ████████████████████████████████████│                   ║
║                                                 └─────────────────────────────────────┘                   ║
║                                                 ┌─────────────────────────────────────┐                   ║
║                                                 │ Testing (5.0d)                      │ Wk 12-13          ║
║                                                 │ ████████████████████████████████████│                   ║
║                                                 └─────────────────────────────────────┘                   ║
║                                                 ┌───────────┐                                             ║
║                                                 │Deploy(2d) │ Wk 13                                       ║
...
║                                                                                                           ║
║ MILESTONES:                                                                                               ║
║   ◆ Wk 12: Historical data migrated and validated                                                         ║
║   ◆ Wk 13: All tests passing, DEV deployment complete                                                     ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════╝

╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║ PHASE 4: DOCUMENTATION & HANDOVER (4.5 days)                                                              ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════╣
║ Week 14-15                                                                                                ║
║                                                                     ┌─────────────────────────┐           ║
║                                                                     │ Documentation (4.5d)    │ Wk 14-15 ║
║                                                                     │ ██████████████████████  │           ║
║                                                                     └─────────────────────────┘           ║
║                                                                                                           ║
║ MILESTONES:                                                                                               ║
║   ◆ Wk 14: Documentation delivered                                                                        ║
║   ◆ Wk 15: Knowledge transfer complete, Final handover                                                    ║
╚═══════════════════════════════════════════════════════════════════════════════════════════════════════════╝
...
═══════════════════════════════════════════════════════════════════════════════════════════════════════════
  ...
  Wk 5  ◆ Solution Design Document approved
  Wk 8  ◆ DBT models complete
  Wk 10 ◆ Orchestration operational
  Wk 12 ◆ Data migration complete
  Wk 13 ◆ Testing complete, DEV deployed
  Wk 15 ◆ Final handover
...
|------|-----|----------|------------------|----------------------------|
| **Lead Solution Architect** | 1.0 | Full engagement (15 weeks) | Solution architecture, complex DBT development, technical leadership, stakeholder management, data migration design | DBT Core (advanced), Snowflake (advanced), Data modeling (advanced), SQL (advanced), Airflow, Semantic Views/Cortex Analyst, Solution design, Data migration |
| **Senior Solution Architect** | 1.0 | Weeks 6-13 (8 weeks) | DBT model development, migration scripts, testing | DBT Core (advanced), Snowflake, SQL (advanced), Python, Data migration, Testing frameworks |
