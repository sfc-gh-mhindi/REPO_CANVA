# AI-Enabled Migration Pilot - Scope of Work (INTERNAL)
...
| **Testing** | Integration and data quality testing in DEV environment |
...
|---|----------------|-------|----------|
| C1 | Grant repository access to existing DBT project | Technical Lead | Week 1 |
| C2 | Provide SME availability (4-6 hrs/week) for requirements and validation | Owen Yan / Wilson | Throughout |
| C3 | Provision 3 Snowflake databases (product_experience_*) | Platform Team | Week 1 |
| C4 | Provision Airflow environment for orchestration | Platform Team | Week 4 |
| C5 | Enable Cortex Code access to Snowflake environment | Platform Team | Week 1 |
| C6 | Provide technical decisions and approvals (2-4 hrs/week) | Mike | Throughout |
| C7 | Share existing documentation and coding standards | Domain SME | Week 1 |
...
## 6. Effort Estimate (INTERNAL)

### 6.1 Effort Summary

| Category | Effort (Days) |
|----------|---------------|
| Migration Delivery (Editor Sessions) | 26 |
| AI Artifact Development | 5 |
| Acceleration Measurement & Reporting | 4 |
| **Total Effort** | **35** |

### 6.2 Detailed Breakdown

#### Migration Delivery (26 days)

| Activity | Effort (Days) |
|----------|---------------|
| Physical Layer Setup | 1 |
...
#### AI Artifact Development (5 days)

| Activity | Effort (Days) |
|----------|---------------|
| Pattern Extraction & Analysis | 1.5 |
| Skill Training & Prompt Engineering | 2 |
| Validation & Iteration | 1 |
| Artifact Documentation | 0.5 |
| **Subtotal** | **5** |

#### Acceleration Measurement (4 days)

| Activity | Effort (Days) |
|----------|---------------|
| Baseline Establishment | 0.5 |
| Metrics Collection | 1.5 |
| Analysis & Reporting | 1.5 |
| Go/No-Go Recommendation | 0.5 |
| **Subtotal** | **4** |
...
*Based on 35 days × $3,224 AUD daily rate*

---

## 7. High-Level Execution Plan (INTERNAL)

### 7.1 Timeline Overview (5 Weeks)

| Week | Focus | Key Activities |
|------|-------|----------------|
| **Week 1** | Setup & Analysis | Environment setup, codebase access, pattern extraction, current state analysis |
| **Week 2** | Design & AI Training | Star schema design, skill training, prompt development |
| **Week 3** | Build | DBT model build (AI-assisted), semantic layer development |
| **Week 4** | Testing & Validation | Integration testing, AI artifact validation, orchestration setup |
| **Week 5** | Measurement & Handover | Acceleration analysis, reporting, go/no-go recommendation, knowledge transfer |

### 7.2 Milestones

| Week | Milestone |
|------|-----------|
| Wk 1 | Codebase access established, patterns documented |
| Wk 2 | Design approved, AI skill initial training complete |
| Wk 3 | DBT models complete, semantic view deployed |
| Wk 4 | Testing complete, orchestration operational |
| Wk 5 | Go/No-Go recommendation delivered |

---

## 8. Resource Allocation (INTERNAL)

### 8.1 Snowflake Professional Services Team

| Role | FTE | Duration | Responsibilities |
|------|-----|----------|------------------|
| **Lead Solution Architect** | 1.0 | 5 weeks | Solution architecture, DBT development, AI skill development, stakeholder management |

### 8.2 Canva Team Requirements

| Role | Commitment | Duration | Responsibilities |
|------|------------|----------|------------------|
| **Domain SME (Owen Yan / Wilson)** | 4-6 hrs/week | Full engagement | Requirements clarification, model validation |
| **Technical Lead (Mike)** | 2-4 hrs/week | Full engagement | Technical decisions, approvals, codebase access |
| **Data Platform Team** | As needed | Full engagement | Airflow infrastructure, database provisioning |

---

## 9. Open Questions (INTERNAL)

| # | Question | Owner | Priority |
|---|----------|-------|----------|
| 1 | Can repository access be granted before engagement start? | Technical Lead | Critical |
| 2 | What is the structure of the existing DBT project (monorepo vs multi-repo)? | Technical Lead | High |
| 3 | Are there coding standards/conventions documented? | Domain SME | High |
| 4 | Which second domain would be used for iterative tuning if needed? | Canva | Medium |
| 5 | What metrics does Canva want to see for go/no-go decision? | Technical Lead | High |
